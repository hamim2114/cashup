...
const CompoundingWithdrawHistory = () => {

  const { data, isLoading, isError } = useQuery({
    queryKey: ['withdrawal-from-compounding-profit'],
    queryFn: () => apiReq.get('/withdrawal-from-compounding-profit/')
  })
    ...
    <Box >
      <nav className="bg-[rgb(33,54,68)] py-3">
        <div className="p-2 flex flex-wrap items-center justify-start gap-10 max-w-screen-xl px-4 mx-auto">
          ...
          <h1 className="text-2xl font-bold text-white">Compounding Withdraw History</h1>
        </div>
      </nav>
...
export default CompoundingWithdrawHistory