        ...
        <section className="pb-10">
          <div className="bg-fuchsia-600 flex flex-col p-5">
            <div className="flex justify-end">
              <Button color="secondary" onClick={() => setProfileEditDialogOpen(true)} variant="contained">Edit</Button>
            </div>
          ...
          <div className="pt-3">
            <button className="btn w-full justify-start bg-white border-none">
              ...
              <p className="text-md">ব্যালান্স অনুসন্ধান</p>
            </button>
            <button className="btn w-full justify-start bg-white border-none">
              <svg
                stroke="currentColor"
              ...
              <p className="text-md">মিনি স্টেটমেন্ট</p>
            </button>
            <button className="btn w-full justify-start bg-white border-none">
              <svg
                stroke="currentColor"
              ...
              <p className="text-md">লেনদেন সীমা</p>
            </button>
            <button className="btn w-full justify-start bg-white border-none">
              <svg
                stroke="currentColor"
              ...
              <p className="text-md">সেবা চার্জ</p>
            </button>
            <button className="btn w-full justify-start bg-white border-none">
              <svg
                stroke="currentColor"
              ...
              <p className="text-md">আমার কিউআর</p>
            </button>
            <button className="btn w-full justify-start bg-white border-none shadow-none">
              ...
              <p className="text-md">স্টোরের অবস্থান</p>
            </button>
            <Link to='/order-history'>
              <button className="btn w-full justify-start bg-white border-none shadow-none">
                <ShoppingCartCheckout sx={{ color: '#7F22CE' }} />
                <p className="text-md">অর্ডার হিস্টোরি</p>
              </button>
            </Link>
            <Link to='/main-balance-withdraw-history'>
              <button className="btn w-full justify-start bg-white border-none shadow-none">
                <SettingsBackupRestore sx={{ color: '#7F22CE' }} />
                <p className="text-md">মেইন ব্যালেন্স উইথড্র হিস্টোরি</p>
              </button>
            </Link>
            <Link to='/cashup-withdraw-history'>
              <button className="btn w-full justify-start bg-white border-none shadow-none">
                <SettingsBackupRestore sx={{ color: '#7F22CE' }} />
                <p className="text-md">ক্যাশআপ উইথড্র হিস্টোরি</p>
              </button>
            </Link>
            <Link to='/compounding-withdraw-history'>
              <button className="btn w-full justify-start bg-white border-none shadow-none">
                <SettingsBackupRestore sx={{ color: '#7F22CE' }} />
                <p className="text-md">চক্রবৃদ্ধি উইথড্র হিস্টোরি</p>
              </button>
            </Link>
          </div>
          ...
          <div className="shadow-lg pb-3">
            <button className="btn w-full justify-start bg-white border-none">
              ...
              <p className="text-md">আমাদের সম্পর্কে</p>
            </button>
            <button className="btn w-full justify-start bg-white border-none">
              <svg
                stroke="currentColor"
            ...
            <button className="btn w-full justify-start bg-white border-none">
              ...
              <p className="text-md">অভিযোগ/প্রতিক্রিয়া</p>
            </button>
            <button onClick={() => logout()} className="btn w-full justify-start bg-white border-none">
              <svg
                stroke="currentColor"
                fill="currentColor"
                strokeWidth="0"
